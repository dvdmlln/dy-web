<template lang="pug">
	v-card(light tile)
		v-card-title
			div.text-h5.text-sm-h3.text-md-h2.font-weight-bold Datenschutz&shy;erkl&auml;rung
			v-spacer
		...
		v-card-text
			...
			h4 Wof&uuml;r nutzen wir Ihre Daten?
			p
			...
			h4 Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?
			p
			...
			h2 2. Allgemeine Hinweise und Pflicht&shy;informationen
			h3 Datenschutz
			p
			...
			p
				| David Mellen
				br
				| Krawehlstra&szlig;e 44
				br
				| 45130 Essen
			p
				| Telefon: +491632729193
				br
				| E-Mail: info@decemberyouth.de
			p
			...
			h3 Recht auf Daten&shy;&uuml;bertrag&shy;barkeit
			p
			...
			h3 SSL- bzw. TLS-Verschl&uuml;sselung
			p
			...
			h3 Auskunft, L&ouml;schung und Berichtigung
			p
			...
			h3 Recht auf Einschr&auml;nkung der Verarbeitung
			p
			...
			h3 Spotify
			p
				| Auf dieser Website sind Funktionen des Musik-Dienstes Spotify eingebunden. Anbieter ist die Spotify AB, Birger Jarlsgatan 61, 113 56 Stockholm in Schweden. Eine &Uuml;bersicht &uuml;ber die Spotify-Plugins finden Sie unter: 
				a(href='https://developer.spotify.com' target='_blank' rel='noopener noreferrer') https://developer.spotify.com
				| .
			p
			...
			p
				...
				a(href='https://www.spotify.com/de/legal/privacy-policy/' target='_blank' rel='noopener noreferrer') https://www.spotify.com/de/legal/privacy-policy/
				| .
			p
...
<script lang="ts" src="./dy-privacy.ts"></script>
